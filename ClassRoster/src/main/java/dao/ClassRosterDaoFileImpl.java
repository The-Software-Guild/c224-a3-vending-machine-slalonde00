...
public class ClassRosterDaoFileImpl implements ClassRosterDao {
    ...
    public void loadStudent() throws ClassRosterPersistenceException, FileNotFoundException {
        Scanner s;
        try {
    ...
    private String marshallStudents(Student someStudent) {
        ...
        studentAsString += someStudent.getGrade()+ delemiter;
        studentAsString += someStudent.getId() + delemiter;
